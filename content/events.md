...
events:
  ...
  # ═══════════════════════════════════════════════════════════════════════════
  # DEACTIVATED LEGACY EVENTS (kept for referential integrity)
  # ═══════════════════════════════════════════════════════════════════════════
  ...
  - id: "e1000001-0000-0000-0000-000000000001"
    ...
    description: Superseded by age-specific categories.
    is_team: false
    is_active: false
  ...
  - id: "e1000001-0000-0000-0000-000000000003"
    ...
    max_participants: 30
    location: Main Lawn
    description: Superseded by age-specific category.
    is_team: true
    is_active: false
  ...
  - id: "e1000001-0000-0000-0000-000000000009"
    ...
    description: Superseded by gender-specific categories.
    is_team: false
    is_active: false
  ...
  - id: "e1000001-0000-0000-0000-000000000015"
    ...
    max_participants: 12
    location: Clubhouse Hall 3
    description: Superseded by Chess (Age 16+).
    is_team: false
    is_active: false
